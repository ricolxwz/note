...
???+ warning "注意"
    ...
    - 摘要函数只能处理二进制数据, 因此如果传入的是普通字符串必须将传入的字符串经过[UTF-8编码](/language/python/foundation/encoding/#UTF-8编码和解码)或者其他编码之后转为比特字符串.
...
[^1]: Hashlib. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017686752491744