...
`datetime.now()`会返回一个`datetime`类的实例. 这个对象中有一个`__repr__`方法, 详情参见[`__str__`方法](/language/python/foundation/object/#str), 可以用于打印这个对象, 内容是它所代表的时间.
...
???+ example "例子"
    ...
    ???+ warning "注意"
        ...
        ???+ example "例子"
            ...
            ```
            $ python main.py
            2022-06-18 01:50:26.278879+00:00
            <class 'datetime.datetime'>
            ```
...
???+ example "例子"
    ...
    ```
    2022-06-18 12:10:29.281663
    2022-06-18 22:10:29.281663
    2022-06-17 00:10:29.281663
    ```
...
???+ example "例子"
    ...
    ```
    $ python main.py
    2022-06-18 12:34:23.874828
    2022-06-18 12:34:23.874828+08:08
    ```
...
???+ example "例子"
    ...
    ```
    $ python main.py
    2022-06-18 12:44:19.574895
    2022-06-18 12:44:19.574895+08:00
    2022-06-18 13:44:19.574895+09:00
    ```

[^1]: Datetime. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017648783851616