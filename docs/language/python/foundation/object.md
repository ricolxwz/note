...
`__iter__()`特殊方法可以把一个实例变为[迭代器](/language/python/foundation/container/#迭代器). 该方法返回一个[迭代器](/language/python/foundation/container/#迭代器), 然后for循环就会不断调用该迭代对象的`__next__()`方法拿到下一个值, 知道遇到`StopIteration`错误退出循环.
...
[^1]: 访问限制. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017496679217440
[^2]: 使用__slots__. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017501655757856
[^3]: 多重继承. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017502939956896
[^4]: 使用@property. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017502538658208
[^5]: 定制类. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017590712115904
[^6]: 使用枚举类. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017595944503424
[^7]: 使用元类. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017592449371072