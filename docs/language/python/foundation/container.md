...
实现了[`__iter__`](/language/python/foundation/object/#iter)和`__next__`方法的对象称为迭代器.
...
也就是说, 生成器对象都是迭代器, 但不是所有的迭代器都是生成器对象(可以通过[定制类](/language/python/foundation/object/#定制类)实现相同的效果). 列表, 字典, 字符串虽然是可迭代对象, 但不是迭代器. 
...
[^1]: 使用list和tuple. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017092876846880
[^2]: 使用dict和set. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017104324028448
[^3]: Python中列表的常用操作. (n.d.). 知乎专栏. From https://zhuanlan.zhihu.com/p/639394226
[^4]: 切片. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017269965565856
[^5]: 迭代. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017316949097888
[^6]: 列表生成式. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017317609699776
[^7]: 生成器. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017318207388128
[^8]: 迭代器. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017323698112640