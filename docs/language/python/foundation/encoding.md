...
参见[base64编码](/language/python/basic-package/base64)

???+ warning "注意"

    [base64编码](/language/python/basic-package/base64)编码的是二进制数据, 而不是字符串. 它是一种针对二进制数据的一种字符编码方式, 用于将原始二进制数据转为base64编码的二进制数据以及将base64编码的二进制数据转换为原始二进制数据.
...
[^2]: 文本文件与二进制文件的编码差别-阿里云开发者社区. (n.d.). From https://developer.aliyun.com/article/4031
