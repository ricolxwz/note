...
`map()`函数接收两个参数, 一个是函数(接收一个参数, 返回一个值), 一个是[可迭代对象(Iterable)](/language/python/foundation/container/#迭代器和可迭代对象的区别), `map()`将传入的函数依次作用到序列的每一个元素, 并把结果作为新的[迭代器(Iterator)](/language/python/foundation/container/#迭代器和可迭代对象的区别)返回. 
...
`reduce()`函数接收两个参数, 一个是函数(接收两个参数, 返回一个值), 一个是[可迭代对象(Iterable)](/language/python/foundation/container/#迭代器和可迭代对象的区别), `reduce()`首先会移除序列的前两个元素, 将传入的函数依次作用到这两个元素, 然后将返回值放回到序列中.(1) 最终返回一个单一的值 (特别适合做累计计算).
{ .annotate }
...
`filter()`函数接收两个参数, 一个是函数(接收一个参数, 返回True/False), 一个是[可迭代对象(Iterable)](/language/python/foundation/container/#迭代器和可迭代对象的区别), `filter()`将传入的函数依次作用于序列的每一个元素, 选择保留或者丢弃该元素, 并把结果作为新的[迭代器(Iterator)](/language/python/foundation/container/#迭代器和可迭代对象的区别)返回. 
...
`sorted()`函数接收两个参数, 一个是[可迭代对象(Iterable)](/language/python/foundation/container/#迭代器和可迭代对象的区别), 一个是函数(接收一个参数, 返回一个值). 这个函数要以关键字参数的形式传入. 并把结果作为新的[可迭代对象(Iterable)](/language/python/foundation/container/#迭代器和可迭代对象的区别)返回. 
...
[^1]: 函数的参数. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017261630425888
...
[^3]: 高阶函数. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017328655674400
[^4]: 返回函数. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017434209254976
[^5]: 匿名函数. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017451447842528
[^6]: 装饰器. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017451662295584
[^7]: 偏函数. (n.d.). From https://www.liaoxuefeng.com/wiki/1016959663602400/1017454145929440
[^8]: Python 类型提示简介—FastAPI. (n.d.). From https://fastapi.tiangolo.com/zh/python-types/
[^9]: Python 如何使用类型提示指定多个返回类型|极客教程. (n.d.). From https://geek-docs.com/python/python-ask-answer/472_python_how_to_specify_multiple_return_types_using_typehints.html