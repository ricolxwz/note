...
???+ info "信息"
    ...
    - [数据类型](/language/python/numpy/datatype)
    - [数组构建](/language/python/numpy/array-creation)
    - [数组索引](/language/python/numpy/array-index): [字段索引](#字段索引)
...
详情见[这里](/language/python/numpy/array-index/#字段索引).
...
[^1]: 结构化数组—NumPy v1.26 手册—NumPy 中文. (n.d.). From https://numpy.com.cn/doc/stable/user/basics.rec.html