...
[^1]: NumPy 数据类型 | 菜鸟教程. (n.d.). From https://www.runoob.com/language/python/numpy/numpy-dtype.html
[^2]: Data type objects (dtype)—NumPy v2.0 Manual. (n.d.). From https://numpy.org/doc/stable/reference/arrays.dtypes.html
[^3]: Scalars—NumPy v2.0 Manual. (n.d.). From https://numpy.org/doc/stable/reference/arrays.scalars.html