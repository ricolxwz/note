...
???+ example "例子"
    ...
    === "例子5"
        ...
        关于`a[:, np.newaxis]`用于将一维行向量转为列向量, 详情见[这里](/language/python/numpy/array-index/#返回数组的维度)
...
[^2]: NumPy 广播(Broadcast) | 菜鸟教程. (n.d.). From https://www.runoob.com/language/python/numpy/numpy-broadcast.html