...
???+ tip "Tip"
    ...
    Series和DataFrame和NumPy中的[结构化数组](/language/python/numpy/structured-array)类似, 功能上, 前者远胜后者.
...
[^1]: 第二章 pandas基础—Joyful Pandas 1.0 documentation. (n.d.). From https://inter.joyfulpandas.datawhale.club/Content/ch2.html