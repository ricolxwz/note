...
存储过程, stored procedure, 是在大型数据库系统中, 一组为了完成特定功能的SQL语句集. 经过编译创建并保留在数据库中, 用户可以通过存储过程的名字并给定参数来调用执行. 如[图](http://img.ricolxwz.cn/046d2f1f099f461536ae9ecd2529d8e5.png)所示, 下面的部分就是存储过程的架构示意图.
