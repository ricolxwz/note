...
机器学习中的[非线性支持向量机](https://note.ricolxwz.de/algorithm/svm/#non-linear-svm)用到了核函数, 我们通过一个变换$\phi$将原始特征空间映射到新的特征空间, 在新的特征空间中, 决策边界可能会变成线性的. 其中我们使用[核函数](https://note.ricolxwz.de/algorithm/svm/#kernel-function)在原始特征空间计算点积, 从而减少了算力消耗.  
