...
<figure markdown='1'>
![](https://img.ricolxwz.download/d497a05e2096fd85dfc4dcf04ffffd62.png){ loading=lazy width='400' }
</figure>
...
还可以通过对微分熵的加减形成其他信息量, 如微分互信息$I_D(X;Y)$. 微分互信息继承了[离散互信息的性质](/general/information-theory/what-is-information/#互信息), 如$I_D(X;Y)>0$, 还有一些额外的性质: 
...
很多时候, $X$和$Y$虽然是同向变化, 但是它们变化的幅度不一样, 如[图](https://img.ricolxwz.download/ef6d91e949fa6691ef2eae243a51a766.png)所示, 情况一的协方差会远远大于情况二的协方差.
...
<figure markdown='1'>
![](https://img.ricolxwz.download/6d1ea415085ecd372aa60f6bdbf63fae.png){ loading=lazy width='800' }
</figure>
...
机器学习中的[非线性支持向量机](/algorithm/svm/#non-linear-svm)用到了核函数, 我们通过一个变换$\phi$将原始特征空间映射到新的特征空间, 在新的特征空间中, 决策边界可能会变成线性的. 其中我们使用[核函数](/algorithm/svm/#kernel-function)在原始特征空间计算点积, 从而减少了算力消耗.  
...
<figure markdown='1'>
![](https://img.ricolxwz.download/705268d17c4514bc1de00244c0c0d1a4.png){ loading=lazy width='300' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/86a4b3bfa5544f950d82cfa4292110fe.png){ loading=lazy width='350' }
</figure>
...
[^1]: 如何通俗易懂地解释「协方差」与「相关系数」的概念？ - 知乎. (n.d.). From https://www.zhihu.com/question/20852004
