...
<figure markdown='1'>
![](http://img.ricolxwz.cn/a7f34828dfed10ebf293bb2b0cf2b104.png){ loading=lazy width='200' }
</figure>

左侧是源变量, 右侧是目标变量. 在这种情况下, 目标变量只是简单地复制源变量的消息. 源变量的消息状态的转变符合泊松分布. 将源变量记为$s$, 目标变量记为$t$, 有$t_{n+1}=s_n$.

<figure markdown='1'>
![](http://img.ricolxwz.cn/dab1a772c5a6d3dc55345d9dfb1465ea.png){ loading=lazy width='250' }
</figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/95f22e475af285b2d1cf69de0cec0c87.png){ loading=lazy width='250' }
</figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/33fbfbc509e98244e8dd31f7e903cc30.png){ loading=lazy width='280' }
</figure>
...
- 冗余去除: 如果源变量$Y$和条件变量$Z$之间共享某些信息, 这种冗余信息会被条件化消除
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/ea71b0c1bb9bd1601d1d87a06bf026eb.png){ loading=lazy width='280' }
    </figure>
- 协同效应: 当$Y$和$Z$共同作用影响$X$的时候, 能够捕捉到这种协同信息
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/b0dcb14f8456a3a5d15f59f0198158a0.png){ loading=lazy width='180' }
    </figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/55d4376cb94e5e341d9ed3382f3b3329.png){ loading=lazy width='500' }
</figure>
