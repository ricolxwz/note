...
<figure markdown='1'>
![](http://img.ricolxwz.cn/7b64c88a1a92c1805aecf02b76d5c679.png){ loading=lazy width='400' }
</figure>
...
???+ example "例子"
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/06853a90f88f172bc0e710a6f551656d.png){ loading=lazy width='300' }
    </figure>
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/89db496511dfb7d4cedd80c50aad8a05.png){ loading=lazy width='300' }
    </figure>
...
???+ example "例子"
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/2e166902b66dc31881b927e274c403a4.png){ loading=lazy width='400' }
    </figure>

    HMM就是在这个基础上, 加入了一个隐藏状态和观测状态的概念.

    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/015f83e68047ff2b374f6a36781a7bd6.png){ loading=lazy width='400' }
    </figure>

    图中, X的状态是不可见的, 而Y的状态是可见的. 我们可以将X看成是天气情况, 而Y看成是某个人穿的衣物类型, 如下图所示.

    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/5ad9c697155c00ebf6ee8e4f8fd611b4.png){ loading=lazy width='400' }
    </figure>
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/3faef5ee59ce156c08236dbc928ce456.png){ loading=lazy width='300' }
    </figure>
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/1150eb0fe6c7bfe1390438827e567784.png){ loading=lazy width='400' }
    </figure>

    可视化表达:

    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/e4556d9676b6bd8bb2ee73554008d8d1.png){ loading=lazy width='400' }
    </figure>
...
???+ example "例子"
	...
	<figure markdown='1'>
	![](http://img.ricolxwz.cn/73629b7b37cb523a56c45c42c1a30fc4.png){ loading=lazy width='400' }
	</figure>
