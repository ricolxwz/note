...
<figure markdown='1'>
![](http://img.ricolxwz.cn/d7068ef901f3546bee95f37508f59d83.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/e9f5fe7ebe5c3a9a81e7754e3ac799ee.png){ loading=lazy width='500' }
</figure>

答案是$Z_1$轴, 如图所示.

<figure markdown='1'>
![](http://img.ricolxwz.cn/858f3ee26803470379d34852975ff769.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/369b36dea39de9c2e6a317ede6bdc7e7.png){ loading=lazy width='500' }
</figure>
...
2. 肘部法, Elbow Method. 绘制主成分的数量和累积方差图, 通常会在曲线上出现一个"肘点", 表示方差的增长速度开始减缓的地方, 这通常是一个合理的选择, 因为在此之后增加更多的维度带来的方差增益有限, 如下图, 总方差的$95\%$对应的是$153$维, 而肘点对应的是$100$维
    ...
    <figure markdown='1'>
    ![](http://img.ricolxwz.cn/d27b500548b5b83cdbcb86d3f6ebcda6.png){ loading=lazy width='500' }
    </figure>
...
可以在[这里](http://img.ricolxwz.cn/a2a0de53ba8ad8088723f59d956c980c.png)找到一个例子.
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/1d81b1fece181e54d0828d3358f0b458.png){ loading=lazy width='500' }
</figure>
