...
- [神经网络](/algorithm)
    ...
    - ☢️[前向传播](/algorithm/fnn/#backpropagation-algorithm), 给出一张网络的[图](https://img.ricolxwz.cn/58a62f5af6cb3f0dcd287eb696e918a8.png), 计算最后的输出. 使用的是sigmoid函数, $y=1/(1+e^{-x})$, 这个函数记住
