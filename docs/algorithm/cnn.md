...
<figure markdown='1'>
![](https://img.ricolxwz.cn/990dc043f998e4a6c1094e3727596d1e.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/0c9113eddbcf2549ead9cfb26ad8149f.png){ loading=lazy width='550' }
</figure>

该就是2012年Krizhevsky等人在ImageNet竞赛上所使用的架构.它们将错误率降到了$16.4\%$, 如图所示, 人类分类的错误率为$5.1\%$.

<figure markdown='1'>
![](https://img.ricolxwz.cn/0207cc30e840fefc5597352648a16d0b.png){ loading=lazy width='550' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/517a23875de93e3a6aa6bb3f5f45151e.png){ loading=lazy width='300' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/8ec1dc5c2d3391ae61e196e779a18e9c.gif){ loading=lazy width='250' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/6428cf505ac1e9e1cf462e1ec8fe9a68.gif){ loading=lazy width='300' }
</figure>

我们可以将卷积核看作是一个特征发现器. 如下图是一个发现一条曲线的卷积核.

<figure markdown='1'>
![](https://img.ricolxwz.cn/89e8c73e0a019bc95d1a00d3bc6c7024.png){ loading=lazy width='400' }
</figure>

现在, 我们将这个卷积核用于一张我们想要分类图片(一张老鼠🐭的简笔画)的左上角上,

<figure markdown='1'>
![](https://img.ricolxwz.cn/b74c44bf131469e142856c3840828728.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/6afdf8649d233e15c4c79991eaf53d25.png){ loading=lazy width='550' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/0fc4e5268b9e6c471e5c29f62a353e90.png){ loading=lazy width='500' }
</figure>

越大的步幅会产生越小的特征图.

<figure markdown='1'>
![](https://img.ricolxwz.cn/96700a8eb863fe63adef6d2617a6f336.png){ loading=lazy width='300' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/e62b0910ddf7f9ed2b887dd5acc42d15.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/94958fe3ed2ac69fc5b4e3c91235d192.png){ loading=lazy width='250' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/481bdb01acf2586978cb74a8b0241600.png){ loading=lazy width='300' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/8c6ed785207107115ddb8229d47052ae.png){ loading=lazy width='400' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/b73fbed4981a06c10b518b859b9495de.png){ loading=lazy width='400' }
</figure>

哪种池化的方法好取决于给到的任务. MP会选择特征图中像素值最大的, 所以特别适合较黑的图像中较量的特征识别. 而AP会使得特征图更加平滑, 减少细节和噪声.

<figure markdown='1'>
![](https://img.ricolxwz.cn/67e8d8aff90b970d9c5baa6fa945713b.png){ loading=lazy width='550' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/6250c57e0b2c114a04294e75ccde07c5.png){ loading=lazy width='200' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/9fc452848ab61a37f13b4e41c8cb79be.png){ loading=lazy width='550' }
</figure>

如下图所示, 这是一个经过修改的用于多通道的CNN.

<figure markdown='1'>
![](https://img.ricolxwz.cn/753e450b8d33b6ebd540cd81e01c90fb.png){ loading=lazy width='550' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.cn/a16b34d538a9f16749f44a2fe03e2169.png){ loading=lazy width='500' }
</figure>
