...
* [整数线性规划](/algorithm/discrete-optimization/ilp)
* [线性规划运用](/algorithm/discrete-optimization/lpa)
* [大规模优化](/algorithm/discrete-optimization/lso)
* [拉格朗日松弛](/algorithm/discrete-optimization/lr)
* [最大次模覆盖](/algorithm/discrete-optimization/msc)
* [最小权重次模覆盖](/algorithm/discrete-optimization/mwsc)
