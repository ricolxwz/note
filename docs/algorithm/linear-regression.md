...
![](https://img.ricolxwz.download/d4c6115e385685ac90d37dd9785af78e.png){:style="width:400px"}
...
![](https://img.ricolxwz.download/6168b654649a0537c67df6f2454dc9ba.png){:style="width:400px"}
...
![](https://img.ricolxwz.download/82189072956cb8486a0a5da96d3bd25.png){:style="width:400px"}

将其呈现为等高线图:

![](https://img.ricolxwz.download/132051406ce50036d6f9d1efae279e0e.png){:style="width:550px"}
...
![](https://img.ricolxwz.download/5a689f52b3d32a1326fc8a605d4c86b0.png){:style="width:400px"}
...
???+ warning "注意"
	...
	![](https://img.ricolxwz.download/e4ab2e484fd9cfafaf0b36941b8c4991.png){:style="width:400px"}
  
##### 直观理解

考虑梯度下降的公示. 其中求导, 就是取下图红点的切线. 红色直线的斜率正好是三角形的高度除以水平长度, 这条线的斜率为正数, 也就是说它有正导数. 因此, $\theta_1$更新后等于$\theta_1$减去一个正数乘以$\alpha$.

![](https://img.ricolxwz.download/944f6113c29a5c8416914975df789d6c.png){:style="width:550px"}
...
![](https://img.ricolxwz.download/e8bb9742ef0b48c8a1e48f6b5620c195.png){:style="width:550px"}
...
![](https://img.ricolxwz.download/f4990470cacff936fce9bd4b435174ea.jpg){:style="width:200px"}
...
![](https://img.ricolxwz.download/97c5e67685e77eb3bfab5d14903a8b81.png){:style="width:550px"}
...
![](https://img.ricolxwz.download/cd4e3df45c34f6a8e2bb7cd3a2849e6c.jpg){:style="width:400px"}
...
![](https://img.ricolxwz.download/f899ef4cde8fc21ff7cf929789da7b88.png){:sytle="width:600px"}
...
![](https://img.ricolxwz.download/5f48f45bc05b1799abdd8e3cd8b29d73.png){:style="width:500px"}
...
![](https://img.ricolxwz.download/cd50bfc0f4566e6a9edbff070911b996.png){:style="width:500px"}
...
![](https://img.ricolxwz.download/2c6bb6de8391fa8fdfaf784be5390441.png)
...
![](https://img.ricolxwz.download/79812ab60fc6faa5ccccd7f6bbbd8be7.png){:style="width:500px"}
...
![](https://img.ricolxwz.download/62c309e63e41dc8196816a50e735c95d.png){:style="width: 600px"}
...
![](https://img.ricolxwz.download/13510394c11b284db9f3e937e5b5894a.png){:style="width:400px"}
...
我们选取某一个样本, 它的预测结果是$1$的概率是$\sigma(w^Tx_i)$, 预测结果是$0$的概率为$1-\sigma(w^Tx_i)$, 这两个式子本质上是一样的, 设预测结果为$\hat{y_i}$, 那么和真实标签$y_i=\{0, 1\}$相同的概率为$p(y_i|x_i; w)=\sigma(w^Tx_i)^{y_i}[1-\sigma(w^Tx)]^{1-y_i}$, 这个式子怎么看取决于$y_i$, 它的结果是和真实标签$y_i$相同的概率, 它结合了两个函数得到了一个更加精简的函数, 如[图](https://img.ricolxwz.download/8c57a39838b1374b236108e2be915fc0.png). 这个就是似然函数.
...
![](https://img.ricolxwz.download/3fa32c508830b64c1e28061a4a73b218.png){:style="width:400px"}
...
![](https://img.ricolxwz.download/4087692c707dd86e20194bcec2dc5602.png){:style="width:400px"}
...
[^1]: Machine-learning-deep-learning-notes/machine-learning/linear-regression.md at master · loveunk/machine-learning-deep-learning-notes. (n.d.). From https://github.com/loveunk/machine-learning-deep-learning-notes/blob/master/machine-learning/linear-regression.md
[^2]: 第3章 线性模型. (n.d.). from https://datawhalechina.github.io/pumpkin-book/#/chapter3/chapter3
[^3]: 周志华. (n.d.). 机器学习.
...
[^5]: 什么是特征工程？—特征工程解释—AWS. (n.d.). Amazon Web Services, Inc. From https://aws.amazon.com/cn/what-is/feature-engineering/
[^6]: L1、L2正则化的原理及适用场景_l1正则化-CSDN博客. (n.d.). From https://blog.csdn.net/xiao_ling_yun/article/details/128255215
[^7]: 回归模型中的哑变量是个啥？何时需要设置哑变量？. (n.d.). From https://www.sohu.com/a/199698358_489312
