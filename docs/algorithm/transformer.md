...
<figure markdown='1'>
![](https://img.ricolxwz.download/aeac87fbc55d405f507b73b96ac912e4.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/02a726e225f7010356c7d65bfb3ee8d5.png){ loading=lazy width='700' }
</figure>

打开这个黑箱子, 我们会发现有一个编码组件, 一个解码组件, 以及它们之间的连接.

<figure markdown='1'>
![](https://img.ricolxwz.download/c262cf206d9060f0b436de9590852701.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/576e37e4cd6ed2d8923b3e274417e5e2.png){ loading=lazy width='500' }
</figure>
...
- 第二层是[前馈神经网络](/algorithm/fnn)

<figure markdown='1'>
![](https://img.ricolxwz.download/1da193b987cd1d6838e4665b4c19d548.png){ loading=lazy width='500' }
</figure>

解码器也会有这两层, 除了这两层之外, 还有一个夹在中间的编码器-解码器注意力层. 自注意力层用于关注解码器已经生成的部分的重要信息和上下文关系, 编码器-解码器注意力层用于参考/关注编码器输入序列的编码表示.

<figure markdown='1'>
![](https://img.ricolxwz.download/1dcad850e25c516fee17a32ed76452e1.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/226c51fe49f5d580c0554d4820df362e.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/dbeb1331cff42a9f74fa2ff22148327f.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/eb79b0cfd8d61a555d7f654cb4022e11.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/a103df16bceed84e7dd0dac59042db48.png){ loading=lazy width='400' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/45dbc2a47b2cd6d2ef8ba28ef2fac164.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/f64cbdcf1d883ede36b26067e34f4e3e.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/03d0a60b60a0a28f52ed903c76bb9a22.png){ loading=lazy width='500' }
...
<figure markdown='1'>
![](https://img.ricolxwz.download/087b831f622f83e4529c1bbf646530f0.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/eea2dcbfa49df9fb799ef8e6997260bf.png){ loading=lazy width='300' }
</figure>

接着, 由于我们使用了矩阵计算, 我们可以把上面的第二步和第六步压缩为一步, 直接得到输出.

<figure markdown='1'>
![](https://img.ricolxwz.download/752c1c91e1b4dbca1b64f59a7e026b9b.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/ebef9242633eaeaa58c7ae3429b33d13.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/9a245789280ff24b8637f0ffe7f2f8a0.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/9a721b7e3b77140f0a51e6cb38117209.png){ loading=lazy width='600' }
</figure>

这就是多头注意力机制的全部内容, 下面是一张汇总图.

<figure markdown='1'>
![](https://img.ricolxwz.download/3cd76d3e0d8a20d87dfa586b56cc1ad3.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/6cfe032799b48017bbb21103a0cc4892.png){ loading=lazy width='400' }
</figure>

如果我们把所有的注意力头都在图上画出来, 会变成这个样子.

<figure markdown='1'>
![](https://img.ricolxwz.download/9cd4154bc491304fb8b0518cff1b872c.png){ loading=lazy width='400' }
</figure>

## 词嵌入

请见[这里](/algorithm/word-embedding).
...
<figure markdown='1'>
![](https://img.ricolxwz.download/32993fd5f1b712dc93db93830d5900ec.png){ loading=lazy width='600' }
</figure>

如果我们假设嵌入向量的维度是$4$, 那么位置编码向量可能如下所示.

<figure markdown='1'>
![](https://img.ricolxwz.download/d1ad72abf15e81966a448248e7d4c8b7.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/afad13e06cc0454f7d4a3ddafb6ccf32.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/c35ed6b9a6405146557671f2819881d9.png){ loading=lazy width='500' }
</figure>

## 残差连接

关于残差连接, 可以参考[ResNet](/algorithm/resnet).
...
<figure markdown='1'>
![](https://img.ricolxwz.download/01883e4cf179997b19a95c3826c83215.png){ loading=lazy width='400' }
</figure>

将Add&Normalize层可视化, 可以得到.

<figure markdown='1'>
![](https://img.ricolxwz.download/b831c7d0981cae1f9e0127c27d1e5391.png){ loading=lazy width='400' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/406921881ee31e9f56f9d7300f41f57e.png){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/0973bef4fa0892557b1049e436f097e7.gif){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/dce969fd736d3fc3535cc1222bceab2d.gif){ loading=lazy width='600' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/97652550f350209b238757b1f9660497.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/16f981983e1247ef0eec0459e97b737e.png){ loading=lazy width='500' }
</figure>

构造好输出词汇表后, 我们就可以使用One-Hot编码使用相同长度的向量来表示词汇表中的一个词. 例如, 我们可以把单词"am"用下面的向量来表示.

<figure markdown='1'>
![](https://img.ricolxwz.download/085330e629dc9f7d6d5e49d5f9acec9b.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.download/74bf8db4543d6187960ee3cea18e1703.png){ loading=lazy width='500' }
</figure>

由于模型的参数都是随机初始化的. 第一步模型在每个词输出的概率都是随机的. 我们可以把这个概率和正确的概率做对比, 然后使用反向传播来调整模型的权重, 使得输出的概率分布更加接近真实输出.

那么要怎么比较两个概率分布, 我们可以借助信息论的工具, 详情见[交叉熵](/general/information-theory/what-is-information/#交叉熵)和[KL散度](/general/information-theory/what-is-information/#KL散度).
...
<figure markdown='1'>
![](https://img.ricolxwz.download/cb2581e2f1b3f673f0e1b53e2c100a26.png){ loading=lazy width='500' }
</figure>

我们使用例子中的句子训练模型, 希望产生如上图所示的概率分布(最佳, 理想状态, 实际上很难达到), 我们的模型在一个足够大的数据集上, 经过长时间的训练后, 可能产生的概率分布如下图所示.

<figure markdown='1'>
![](https://img.ricolxwz.download/3c8ce3f741d432fcadf75c93d13a20a5.png){ loading=lazy width='500' }
</figure>
...
[^1]: 第二章：Transformer 模型 · Transformers快速入门. (不详). 从 https://transformers.run/c1/transformer/#%E6%B3%A8%E6%84%8F%E5%8A%9B%E5%B1%82
[^2]: Alammar, J. (不详). The Illustrated Transformer. 从 https://jalammar.github.io/illustrated-transformer/
[^3]: 细节拉满，全网最详细的Transformer介绍（含大量插图）！. (不详). 知乎专栏. 从 https://zhuanlan.zhihu.com/p/681532180
