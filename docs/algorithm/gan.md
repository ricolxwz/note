...
![](https://img.ricolxwz.download/e84be7219f469337dba9997250d8fbeb.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.download/e84be7219f469337dba9997250d8fbeb_inverted.webp#only-dark){ loading=lazy width='500' }
</figure>
...
<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/96f9f3dd69247dea84c045d5217213d5.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.download/96f9f3dd69247dea84c045d5217213d5_inverted.webp#only-dark){ loading=lazy width='500' }
</figure>
...
<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/d1eca8cec0744fe585304e99a3db549b.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.download/d1eca8cec0744fe585304e99a3db549b_inverted.webp#only-dark){ loading=lazy width='500' }
</figure>
...
<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/2dc8d471d0117149df27695828605bcf.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.download/2dc8d471d0117149df27695828605bcf_inverted.webp#only-dark){ loading=lazy width='500' }
</figure>
...
<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/6349b54a8fd51a2b2a87dff5e9f80f74.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.download/6349b54a8fd51a2b2a87dff5e9f80f74_inverted.webp#only-dark){ loading=lazy width='500' }
</figure>
...
1. 判别器$D$太强, 过拟合
    ...
    <figure markdown='1' id='fig'>
    ![](https://img.ricolxwz.download/20094716bda5e41ab69ade05c8241c36.webp#only-light){ loading=lazy width='300' }
    ![](https://img.ricolxwz.download/20094716bda5e41ab69ade05c8241c36_inverted.webp#only-dark){ loading=lazy width='300' }
    </figure>
...
2. 数据本身的特性
    ...
    <figure markdown='1' id='fig'>
    ![](https://img.ricolxwz.download/4f67c7a2945489fb8fa894e748b366f4.webp#only-light){ loading=lazy width='300' }
    ![](https://img.ricolxwz.download/4f67c7a2945489fb8fa894e748b366f4_inverted.webp#only-dark){ loading=lazy width='300' }
    </figure>

    解决的方法有两种, 一种是给数据添加噪声, 让生成器和真实分布的低维流形更容易重叠在一起, 如下图所示.

    <figure markdown='1' id='fig'>
    ![](https://img.ricolxwz.download/a77eed271091ba5d3f1fbf006748ad35.webp#only-light){ loading=lazy width='300' }
    ![](https://img.ricolxwz.download/a77eed271091ba5d3f1fbf006748ad35_inverted.webp#only-dark){ loading=lazy width='300' }
    </figure>
...
<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/5e013f9a1986d51f076bfb156b66af1d.webp#only-light){ loading=lazy width='300' }
![](https://img.ricolxwz.download/5e013f9a1986d51f076bfb156b66af1d_inverted.webp#only-dark){ loading=lazy width='300' }
</figure>

而我们设想的学习过程应该是这个样子:

<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/2b98445d236baf686d2c620cf5d901bb.webp#only-light){ loading=lazy width='800' }
![](https://img.ricolxwz.download/2b98445d236baf686d2c620cf5d901bb_inverted.webp#only-dark){ loading=lazy width='800' }
</figure>

但是实际上却事与愿违:

<figure markdown='1' id='fig'>
![](https://img.ricolxwz.download/b31e399acd905b22889956cd2460f70c.webp#only-light){ loading=lazy width='800' }
![](https://img.ricolxwz.download/b31e399acd905b22889956cd2460f70c_inverted.webp#only-dark){ loading=lazy width='800' }
</figure>
