...
<figure markdown='1'>
![](http://img.ricolxwz.cn/182181d298a387078d650701b708d254.png){ loading=lazy width='500' }
</figure>
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/4392978da300d80f0485a0aa396966ff.png){ loading=lazy width='500' }
</figure>

要注意的是, 梯度下降算法并不保证能找到全局最小值, 它只会找到基于起点的最近的局部最小值.

<figure markdown='1'>
![](http://img.ricolxwz.cn/21ad32b9aa5ba67e5b0f6abc71d55d08.png){ loading=lazy width='500' }
</figure>
...
1. 若$q$是输出层的神经元, 则$\delta_q=(t_q-o_q)f'(z_q)$, 见[图](http://img.ricolxwz.cn/5f941efe6d1e0e2a24f4cc02e2b5f50c.png)
2. 若$q$是隐藏层的神经元, 则$\delta_q=f'(z_q)\sum_i w_{qi}\delta_i$, 见[图](http://img.ricolxwz.cn/240c3a21ce4f4009099695a2a1c28f42.png)
...
???+ example "例子"
    ...
    === "1--->"
        ...
        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/efbaeae02cd8777f9b80255112fe680c.png){ loading=lazy width='550' }
        </figure>

    === "2--->"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/c5859d33d92cbffd51fa2b05db6f50e3.png){ loading=lazy width='650' }
        </figure>

    === "3--->"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/4fbfa4681dde83cc2983beabf18b2b5c.png){ loading=lazy width='650' }
        </figure>

    === "4--->"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/ad1fbdd3eb510d21579643d0c982ea49.png){ loading=lazy width='650' }
        </figure>

    === "5--->"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/478525aca15db7ed94df36a9839ac82d.png){ loading=lazy width='650' }
        </figure>

    === "6--->"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/e053763d1f673ce6b687928f85addb82.png){ loading=lazy width='650' }
        </figure>

    === "7"

        <figure markdown='1'>
        ![](http://img.ricolxwz.cn/84b6a3083f59e94953f1dff056775fd7.png){ loading=lazy width='650' }
        </figure>
...
隐藏层神经元对误差的影响如[图](http://img.ricolxwz.cn/54225f471feeb87e7664d00730b2f0cf.png).
...
3. 此时, 向隐藏层中添加一些新神经元, 并使用随机初始化的权重重新训练网络, 均方误差会减少, 如[图](http://img.ricolxwz.cn/b8176513be1475a51dbd250cd4e9bcdc.png)
...
<figure markdown='1'>
![](http://img.ricolxwz.cn/8a0280ce5fa12521df322cc115dfe04d.png){ loading=lazy width='500' }
</figure>
