...
<figure markdown='1'>
![](https://img.ricolxwz.io/84eb2b84b063a9220fd7325a70b10e4c.webp#only-light){ loading=lazy width='800' }
![](https://img.ricolxwz.io/84eb2b84b063a9220fd7325a70b10e4c_inverted.webp#only-dark){ loading=lazy width='800' }
...
<figure markdown='1'>
![](https://img.ricolxwz.io/af0ec1985beaa09580776e5974f032e3.webp#only-light){ loading=lazy width='800' }
![](https://img.ricolxwz.io/af0ec1985beaa09580776e5974f032e3_inverted.webp#only-dark){ loading=lazy width='800' }
...
<figure markdown='1'>
![](https://img.ricolxwz.io/c1b8074569e7a51ce2c3008dd1caf2dc.webp#only-light){ loading=lazy width='400' }
![](https://img.ricolxwz.io/c1b8074569e7a51ce2c3008dd1caf2dc_inverted.webp#only-dark){ loading=lazy width='400' }
<figcaption>移位窗口. 在左边, 使用的是一种常规的分割策略. 在右边, 是将前一个block的窗口进行移动.</figcaption>
</figure>
...
<figure markdown='1'>
![](https://img.ricolxwz.io/dfcac15ee3737b3ab5f5929822dac872.webp#only-light){ loading=lazy width='600' }
![](https://img.ricolxwz.io/dfcac15ee3737b3ab5f5929822dac872_inverted.webp#only-dark){ loading=lazy width='600' }
</figure>

通过循环移位, 得到的窗口数量和原始窗口数量是一样的, 都是4个, 但是, 可以从上图看到, 左下, 右下, 右上的窗口是由几个在特征图内非相邻的子窗口组成的. 为了解决这个问题, 他们采用了掩码来使自注意力计算限制在各个子窗口内. 

<figure markdown='1'>
![](https://img.ricolxwz.io/ea61d3a1880b70d06eb6a5824b00e023.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.io/ea61d3a1880b70d06eb6a5824b00e023_inverted.webp#only-dark){ loading=lazy width='500' }
<figcaption></figcaption>
</figure>
