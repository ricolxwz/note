...
<figure markdown='1'>
![](https://img.ricolxwz.io/4cb7518300ce438c9aa59a59cf51e252.webp#only-light){ loading=lazy width='500' }
![](https://img.ricolxwz.io/4cb7518300ce438c9aa59a59cf51e252_inverted.webp#only-dark){ loading=lazy width='500' }
...
另一种实现稀疏化的方法是[KL散度](https://note.ricolxwz.de/information-theory/what-is-information/#KL%E6%95%A3%E5%BA%A6). 这种方法不会去调试L1正则化损失函数里面的那个$\lambda$, 从而改变神经元的激活概率, 而是尝试让网络自动调节神经元的激活概率, ^^注意, 这两种方法不同神经元之间的激活概率都是一致的, 即同等力度.^^
...
<figure markdown='1'>
![](https://img.ricolxwz.io/594c13ddb657a2f3bbd38301f86a47a3.webp#only-light){ loading=lazy width='400' }
![](https://img.ricolxwz.io/594c13ddb657a2f3bbd38301f86a47a3_inverted.webp#only-dark){ loading=lazy width='400' }
<figcaption></figcaption>
</figure>
